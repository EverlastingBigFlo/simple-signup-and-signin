...
<div class="bg-black w-full h-full flex justify-center items-center">
    ...
    <form class=" text-gray-300 p-15" action="{{ route('tokenCommand') }}" method="post">
        ...
        <div
            ...
            <div class="p-6">
                <p class="m-5 text-sm font-medium text-white/50">Welcome, enter your token to set up your account.</p>
