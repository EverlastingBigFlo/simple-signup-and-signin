    ...
    <form class="" action="{{ route('loginCommand') }}" method="post">
        ...
        <div>
            <input type="password" name="password" value="{{ old('password') }}" placeholder="Email address"
                class="w-full roundedpy-[0.32rem] leading-[2.15] border-0 bg-transparent px-3  outline-none transition-all duration-200 ease-linear
                focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200
                ">
            <input type="email" name="email" value="{{ old('email') }}"
                class=" block min-h-[auto] w-full rounded    "
